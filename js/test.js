        ...
        return (
            (a = {
                ...
                fix: {
                    console: function () {
                        a.debug("Normalizing window.console"),
                            (console === i || console.log === i) && (a.verbose("Console not available, normalizing events"), a.disable.console()),
                            ("undefined" == typeof console.group || "undefined" == typeof console.groupEnd || "undefined" == typeof console.groupCollapsed) &&
                                (a.verbose("Console group not available, normalizing events"), (t.console.group = function () {}), (t.console.groupEnd = function () {}), (t.console.groupCollapsed = function () {})),
                    ...
                    setting: function (t, n, o, r) {
                        (o = "string" == typeof o ? ("all" === o ? f.modules : [o]) : o || f.modules),
                            ...
                            e.each(o, function (i, o) {
                                var s,
                                    c = a.moduleExists(o) ? e.fn[o].settings.namespace || !1 : !0;
                                a.moduleExists(o) &&
                                    (a.verbose("Changing default setting", t, n, o),
                                    (e.fn[o].settings[t] = n),
                                    r && c && ((s = e(":data(module-" + c + ")")), s.length > 0 && (a.verbose("Modifying existing settings", s), s[o]("setting", t, n))));
                            });
                    },
                        ...
                        (n = "string" == typeof n ? [n] : n || f.modules),
                            ...
                            e.each(n, function (n, i) {
                                ...
                                a.moduleExists(i) &&
                                    ...
                                    o && m && ((r = e(":data(module-" + m + ")")), r.length > 0 && (a.verbose("Modifying existing settings", r), r[i]("setting", t))));
                            });
                    },
                },
                enable: {
                ...
                performance: {
                    log: function (e) {
                        var t, n, i;
                        f.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Element: b, Name: e[0], Arguments: [].slice.call(e, 1) || "", "Execution Time": n })),
            ...
            u ? (y === i && a.initialize(), a.invoke(l)) : (y !== i && a.destroy(), a.initialize()),
            r !== i ? r : this
        );
    }),
        (e.site.settings = {
                    ...
                    (P = {
                        ...
                        bindEvents: function () {
                            P.verbose("Attaching form events"),
                                ...
                                x.keyboardShortcuts && F.on("keydown" + R, k.field, P.event.field.keydown),
                                m.each(function () {
                                    var t = e(this),
                                        n = t.prop("type"),
                        ...
                        clear: function () {
                            m.each(function () {
                                ...
                                c && (P.verbose("Resetting error on field", i), i.removeClass(T.error), o.remove()),
                                    s ? (P.verbose("Resetting dropdown value", n, a), n.dropdown("clear")) : r ? t.prop("checked", !1) : (P.verbose("Resetting field value", t, a), t.val(""));
                            });
                        },
                        reset: function () {
                            m.each(function () {
                                ...
                                r !== i &&
                                    (l && (P.verbose("Resetting error on field", o), o.removeClass(T.error), a.remove()),
                                    c
                                        ? (P.verbose("Resetting dropdown value", n, r), n.dropdown("restore defaults"))
                                        : s
                                        ? (P.verbose("Resetting checkbox value", n, r), t.prop("checked", r))
                        ...
                        event: {
                            field: {
                                keydown: function (t) {
                                    ...
                                    i == o.escape && (P.verbose("Escape key pressed blurring field"), n.blur()),
                                        !t.ctrlKey &&
                                            i == o.enter &&
                                            n.is(k.input) &&
                                            n.not(k.checkbox).length > 0 &&
                                            (j || (n.one("keyup" + R, P.event.field.keyup), P.submit(), P.debug("Enter pressed on input submitting form")), (j = !0));
                                },
                                keyup: function () {
                                    j = !1;
                                },
                        ...
                        get: {
                            ...
                            prompt: function (e, t) {
                                ...
                                return (
                                    ...
                                    l && ((n = i.closest(k.group).find("label").eq(0)), (o = 1 == n.size() ? n.text() : i.prop("placeholder") || x.text.unspecifiedField), (s = s.replace("{name}", o))),
                                    (s = s.replace("{identifier}", t.identifier)),
                                    (s = s.replace("{ruleValue}", r)),
                                    e.prompt || P.verbose("Using default validation prompt for type", s, a),
                                    s
                                );
                            },
                            settings: function () {
                                if (e.isPlainObject(t)) {
                                    ...
                                    a
                                        ? ((x = e.extend(!0, {}, e.fn.form.settings, u)), (C = e.extend({}, e.fn.form.settings.defaults, t)), P.error(x.error.oldSyntax, O), P.verbose("Extending settings from legacy parameters", C, x))
                                        : (t.fields &&
                                              ((n = Object.keys(t.fields)),
                                              ("string" == typeof t.fields[n[0]] || e.isArray(t.fields[n[0]])) &&
                            ...
                            field: function (t) {
                                return (
                                    ...
                                    m.filter("#" + t).length > 0
                                        ...
                                        : m.filter('[name="' + t + '[]"]').length > 0
                                        ? m.filter('[name="' + t + '[]"]')
                                        : m.filter("[data-" + w.validate + '="' + t + '"]').length > 0
                        ...
                        has: {
                            field: function (e) {
                                return (
                                    P.verbose("Checking for existence of a field with identifier", e),
                            ...
                            prompt: function (t, n) {
                                ...
                                (n = "string" == typeof n ? [n] : n),
                                    ...
                                    x.inline &&
                                        ...
                                        r.html(n[0]),
                                        s
                                            ? P.verbose("Inline errors are disabled, no inline error added", t)
                                            : x.transition && e.fn.transition !== i && F.transition("is supported")
                                            ? (P.verbose("Displaying error with css transition", x.transition), r.transition(x.transition + " in", x.duration))
                                            : (P.verbose("Displaying error with fallback javascript animation"), r.fadeIn(x.duration)));
                            },
                            errors: function (e) {
                            ...
                            prompt: function (t) {
                                ...
                                o.removeClass(T.error),
                                    x.inline &&
                                        ...
                                        x.transition && e.fn.transition !== i && F.transition("is supported")
                                            ? a.transition(x.transition + " out", x.duration, function () {
                                                  a.remove();
                                              })
                                            ...
                                            (r && s
                                                ...
                                                ? (P.verbose("Selecting radio value", n, o),
                                                  o
                                                      ...
                                                      .checkbox("check"))
                                                : s
                                                ? (P.verbose("Setting checkbox value", n, a), n === !0 ? a.checkbox("check") : a.checkbox("uncheck"))
                                                : c
                                                ? (P.verbose("Setting dropdown value", n, a), a.dropdown("set selected", n))
                        ...
                        validate: {
                            ...
                            field: function (t, n) {
                                var o = t.identifier || n,
                                    ...
                                    s = [];
                                return (
                                    t.identifier || (P.debug("Using field name as identifier", o), (t.identifier = o)),
                                    a.prop("disabled")
                                        ? (P.debug("Field is disabled. Skipping", o), (r = !0))
                                        : t.optional && "" === e.trim(a.val())
                                        ? (P.debug("Field is optional and empty. Skipping", o), (r = !0))
                                        : t.rules !== i &&
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                x.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: O, "Execution Time": n })),
            ...
            (e.fn.form.settings = {
                ...
                rules: {
                    ...
                    integer: function (t, n) {
                        ...
                        return (
                            n === i || "" === n || ".." === n || (-1 == n.indexOf("..") ? s.test(n) && (o = a = n - 0) : ((r = n.split("..", 2)), s.test(r[0]) && (o = r[0] - 0), s.test(r[1]) && (a = r[1] - 0))),
                        ...
                        if ("string" == typeof t && 0 !== t.length) {
                            if (
                                ...
                                (e.each(c, function (n, i) {
                                    (o = a[i]), o && ((r = { length: -1 !== e.inArray(t.length, o.length), pattern: -1 !== t.search(o.pattern) }), r.length && r.pattern && (s = !0));
                                }),
                                !s)
                            )
                                return !1;
                            if (((i = { number: -1 !== e.inArray(t.length, a.unionPay.length), pattern: -1 !== t.search(a.unionPay.pattern) }), i.number && i.pattern)) return !0;
                            for (
                                var l = t.length,
                                    u = 0,
                                    d = [
                    ...
                    (f = {
                                ...
                                : (f.debug("Opening accordion content", n),
                                  ...
                                  m.animateChildren &&
                                      (e.fn.transition !== i && C.transition("is supported")
                                          ? o.children().transition({ animation: "fade in", queue: !1, useFailSafe: !0, debug: m.debug, verbose: m.verbose, duration: m.duration })
                                          : o.children().stop(!0, !0).animate({ opacity: 1 }, m.duration, f.resetOpacity)),
                        ...
                        close: function (t) {
                            ...
                            (!r && !s) ||
                                ...
                                m.animateChildren &&
                                    (e.fn.transition !== i && C.transition("is supported")
                                        ? o.children().transition({ animation: "fade out", queue: !1, useFailSafe: !0, debug: m.debug, verbose: m.verbose, duration: m.duration })
                                        : o.children().stop(!0, !0).animate({ opacity: 0 }, m.duration, f.resetOpacity)),
                        ...
                        closeOthers: function (t) {
                            ...
                            m.closeNested ? ((n = c.find(l).not(s)), (a = n.next(k))) : ((n = c.find(l).not(s)), (o = c.find(u).find(l).not(s)), (n = n.not(o)), (a = n.next(k))),
                                n.length > 0 &&
                                    ...
                                    m.animateChildren &&
                                        (e.fn.transition !== i && C.transition("is supported")
                                            ? a.children().transition({ animation: "fade out", useFailSafe: !0, debug: m.debug, verbose: m.verbose, duration: m.duration })
                                            : a.children().stop(!0, !0).animate({ opacity: 0 }, m.duration, f.resetOpacity)),
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                m.performance && ((t = new Date().getTime()), (i = r || t), (n = t - i), (r = t), s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: T, "Execution Time": n })),
                    ...
                    (f = {
                            ...
                            popup: function () {
                                if (!m.inline && (A.length || ((A = k.children().first()), A.length))) {
                                    ...
                                    var o = function () {
                                        ...
                                        r = e.extend({}, m.popupOptions, { popup: S, on: a, hoverable: "hover" === a, onShow: o, onVisible: t, onHide: m.onHide, onHidden: n });
                                    f.popup(r);
                                }
                            },
                            inline: function () {
                        ...
                        bind: {
                            events: function () {
                                S.on("mousedown" + C, f.event.mousedown),
                                    ...
                                    T.length
                                        ? (T.on("input" + C, f.event.inputChange), T.on("focus" + C, f.event.inputFocus), T.on("blur" + C, f.event.inputBlur), T.on("click" + C, f.event.inputClick), T.on("keydown" + C, f.event.keydown))
                        ...
                        get: {
                            ...
                            validModes: function () {
                                ...
                                return (
                                    "time" !== m.type &&
                                        ((m.disableYear && "year" !== m.type) || e.push("year"), ((!m.disableMonth && "year" !== m.type) || "month" === m.type) && e.push("month"), m.type.indexOf("date") >= 0 && e.push("day")),
                                    m.type.indexOf("time") >= 0 && (e.push("hour"), m.disableMinute || e.push("minute")),
                                    e
                                );
                            },
                            isTouch: function () {
                        ...
                        helper: {
                            ...
                            dateDiff: function (e, t, n) {
                                ...
                                var i = "time" === m.type,
                                    ...
                                    s = r || "hour" === n;
                                return (
                                    (e = new Date(i ? 2e3 : e.getFullYear(), i ? 0 : o ? 0 : e.getMonth(), i ? 1 : a ? 1 : e.getDate(), s ? e.getHours() : 0, r ? Math.floor(e.getMinutes() / 5) : 0)),
                                    (t = new Date(i ? 2e3 : t.getFullYear(), i ? 0 : o ? 0 : t.getMonth(), i ? 1 : a ? 1 : t.getDate(), s ? t.getHours() : 0, r ? Math.floor(t.getMinutes() / 5) : 0)),
                                    t.getTime() - e.getTime()
                                );
                            },
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                m.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: D, "Execution Time": n })),
                                    clearTimeout(f.performance.timer),
                                    (f.performance.timer = setTimeout(f.performance.display, 500));
                            },
                            display: function () {
                ...
                a.each(function () {
                    ...
                    (f = {
                        ...
                        setup: function () {
                            f.set.initialLoad(),
                                f.is.indeterminate()
                                    ? (f.debug("Initial value is indeterminate"), f.indeterminate())
                                    : f.is.checked()
                        ...
                        event: {
                            click: function (t) {
                                var n = e(t.target);
                                return n.is(h.input)
                                    ? void f.verbose("Using default check action on initialized checkbox")
                                    : n.is(h.link)
                                    ? void f.debug("Clicking link inside checkbox, skipping toggle")
                            ...
                            keydown: function (e) {
                                ...
                                t == n.escape
                                    ? (f.verbose("Escape key pressed blurring field"), w.blur(), (S = !0))
                                    : e.ctrlKey || (t != n.space && t != n.enter)
                                    ? (S = !1)
                                    : (f.verbose("Enter/space key pressed, toggling checkbox"), f.toggle(), (S = !0));
                            },
                            keyup: function (e) {
                                S && e.preventDefault();
                            },
                        ...
                        indeterminate: function () {
                            return f.should.allowIndeterminate()
                                ...
                                : (f.debug("Making checkbox indeterminate"), f.set.indeterminate(), void (f.should.ignoreCallbacks() || (m.onIndeterminate.call(k), m.onChange.call(k))));
                        },
                        determinate: function () {
                            return f.should.allowDeterminate()
                                ? void f.debug("Checkbox is already determinate")
                                : (f.debug("Making checkbox determinate"), f.set.determinate(), void (f.should.ignoreCallbacks() || (m.onDeterminate.call(k), m.onChange.call(k))));
                        },
                        enable: function () {
                        ...
                        should: {
                            allowCheck: function () {
                                return f.is.determinate() && f.is.checked() && !f.should.forceCallbacks()
                                    ? (f.debug("Should not allow check, checkbox is already checked"), !1)
                                    : m.beforeChecked.apply(k) === !1
                                    ? (f.debug("Should not allow check, beforeChecked cancelled"), !1)
                                    : !0;
                            },
                            allowUncheck: function () {
                                return f.is.determinate() && f.is.unchecked() && !f.should.forceCallbacks()
                                    ? (f.debug("Should not allow uncheck, checkbox is already unchecked"), !1)
                                    : m.beforeUnchecked.apply(k) === !1
                                    ? (f.debug("Should not allow uncheck, beforeUnchecked cancelled"), !1)
                                    : !0;
                            },
                            allowIndeterminate: function () {
                                return f.is.indeterminate() && !f.should.forceCallbacks()
                                    ? (f.debug("Should not allow indeterminate, checkbox is already indeterminate"), !1)
                                    : m.beforeIndeterminate.apply(k) === !1
                                    ? (f.debug("Should not allow indeterminate, beforeIndeterminate cancelled"), !1)
                                    : !0;
                            },
                            allowDeterminate: function () {
                                return f.is.determinate() && !f.should.forceCallbacks()
                                    ? (f.debug("Should not allow determinate, checkbox is already determinate"), !1)
                                    : m.beforeDeterminate.apply(k) === !1
                                    ? (f.debug("Should not allow determinate, beforeDeterminate cancelled"), !1)
                                    : !0;
                            },
                            ...
                            checked: function () {
                                return (
                                    ...
                                    !f.is.indeterminate() && f.is.checked()
                                        ? void f.debug("Input is already checked, skipping input property change")
                                        : (f.verbose("Setting state to checked", k), w.prop("indeterminate", !1).prop("checked", !0), void f.trigger.change())
                                );
                            },
                            unchecked: function () {
                                return (
                                    ...
                                    !f.is.indeterminate() && f.is.unchecked() ? void f.debug("Input is already unchecked") : (f.debug("Setting state to unchecked"), w.prop("indeterminate", !1).prop("checked", !1), void f.trigger.change())
                                );
                            },
                            indeterminate: function () {
                                return (
                                    ...
                                    f.is.indeterminate() ? void f.debug("Input is already indeterminate, skipping input property change") : (f.debug("Setting state to indeterminate"), w.prop("indeterminate", !0), void f.trigger.change())
                                );
                            },
                            determinate: function () {
                                return (
                                    ...
                                    f.is.determinate() ? void f.debug("Input is already determinate, skipping input property change") : (f.debug("Setting state to determinate"), void w.prop("indeterminate", !1))
                                );
                            },
                            disabled: function () {
                                return (
                                    ...
                                    f.is.disabled() ? void f.debug("Input is already disabled, skipping input property change") : (f.debug("Setting state to disabled"), w.prop("disabled", "disabled"), void f.trigger.change())
                                );
                            },
                            enabled: function () {
                                return (
                                    ...
                                    f.is.enabled() ? void f.debug("Input is already enabled, skipping input property change") : (f.debug("Setting state to enabled"), w.prop("disabled", !1), void f.trigger.change())
                                );
                            },
                            tabbable: function () {
                        ...
                        toggle: function () {
                            return f.can.change()
                                ? void (f.is.indeterminate() || f.is.unchecked() ? (f.debug("Currently unchecked"), f.check()) : f.is.checked() && f.can.uncheck() && (f.debug("Currently checked"), f.uncheck()))
                                : void (f.is.radio() || f.debug("Checkbox is read-only or disabled, ignoring toggle"));
                        },
                        setting: function (t, n) {
                            if ((f.debug("Changing setting", t, n), e.isPlainObject(t))) e.extend(!0, m, t);
                            else {
    ...
    (function (e, t, n, i) {
        ...
        (e.fn.dimmer = function (t) {
                ...
                a.each(function () {
                    ...
                    (m = {
                        ...
                        bind: {
                            events: function () {
                                "hover" == g.on ? f.on("mouseenter" + y, m.show).on("mouseleave" + y, m.hide) : "click" == g.on && f.on(w + y, m.toggle),
                                    m.is.page() && (m.debug("Setting as a page dimmer", f), m.set.pageDimmer()),
                                    m.is.closable() && (m.verbose("Adding dimmer close event", d), f.on(w + y, p.dimmer, m.event.click));
                            },
                        },
                        unbind: {
                            events: function () {
                        ...
                        create: function () {
                            ...
                            return (
                                g.variation && (m.debug("Creating dimmer with variation", g.variation), t.addClass(g.variation)), g.dimmerName && (m.debug("Creating named dimmer", g.dimmerName), t.addClass(g.dimmerName)), t.appendTo(f), t
                            );
                        },
                        show: function (t) {
                            (t = e.isFunction(t) ? t : function () {}),
                                m.debug("Showing dimmer", d, g),
                                (m.is.dimmed() && !m.is.animating()) || !m.is.enabled() ? m.debug("Dimmer is already shown or disabled") : (m.animate.show(t), g.onShow.call(T), g.onChange.call(T));
                        },
                        hide: function (t) {
                        ...
                        animate: {
                            show: function (t) {
                                (t = e.isFunction(t) ? t : function () {}),
                                    g.useCSS && e.fn.transition !== i && d.transition("is supported")
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                g.performance && ((t = new Date().getTime()), (i = r || t), (n = t - i), (r = t), s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: T, "Execution Time": n })),
                        ...
                        m.preinitialize(),
                        l ? (S === i && m.initialize(), m.invoke(c)) : (S !== i && S.invoke("destroy"), m.initialize());
                }),
                o !== i ? o : this
            );
        }),
            (e.fn.dimmer.settings = {
                ...
                onHide: function () {},
                error: { method: "The method you called is not defined." },
                className: { active: "active", animating: "animating", dimmable: "dimmable", dimmed: "dimmed", dimmer: "dimmer", disabled: "disabled", hide: "hide", pageDimmer: "page", show: "show" },
                    ...
                    (w = {
                        ...
                        observeChanges: function () {
                            "MutationObserver" in t &&
                                ...
                                w.has.input() && x.observe(L[0], { childList: !0, subtree: !0 }),
                                ...
                                return (t = t || w.get.userValues())
                                    ? ((t = e.isArray(t) ? t : [t]),
                                      e.each(t, function (t, r) {
                                          w.get.item(r) === !1 &&
                                              ((a = k.templates.addition(w.add.variables(S.addResult, r))),
                                              (o = e("<div />")
                                                  .html(a)
                                                  .attr("data-" + D.value, r)
                                                  .attr("data-" + D.text, r)
                        ...
                        setup: {
                            ...
                            layout: function () {
                                I.is("select") && (w.setup.select(), w.setup.returnedObject()),
                                    ...
                                    w.is.search() && !w.has.search() && (w.verbose("Adding search input"), (M = e("<input />").addClass(T.search).insertBefore(N))),
                            ...
                            select: function () {
                                ...
                                w.debug("Dropdown initialized on a select", t),
                                    ...
                                    L.parent(P.dropdown).length > 0
                                        ? (w.debug("UI dropdown already exists. Creating dropdown menu only"), (I = L.closest(P.dropdown)), w.has.menu() || w.create.menu(), (U = I.children(P.menu)), w.setup.menu(t))
                                        : (w.debug("Creating entire dropdown from select"),
                                          (I = e("<div />").attr("class", L.attr("class")).addClass(T.selection).addClass(T.dropdown).html(O.dropdown(t)).insertBefore(L)),
                                          L.hasClass(T.multiple) && L.prop("multiple") === !1 && (w.error(F.missingMultiple), L.prop("multiple", !0)),
                                          L.is("[multiple]") && w.set.multiple(),
                                          L.prop("disabled") && (w.debug("Disabling dropdown"), I.addClass(T.disabled)),
                        ...
                        bind: {
                            ...
                            touchEvents: function () {
                                w.debug("Touch device detected binding additional touch events"),
                                    w.is.searchSelection() || (w.is.single() && I.on("touchstart" + q, w.event.test.toggle)),
                                    U.on("touchstart" + q, P.item, w.event.item.mouseenter);
                            },
                            keyboardEvents: function () {
                                w.verbose("Binding keyboard events"),
                                    I.on("keydown" + q, w.event.keydown),
                                    w.has.search() && I.on(w.get.inputEvent() + q, P.search, w.event.input),
                                    w.is.multiple() && s.on("keydown" + b, w.event.document.keydown);
                            },
                            ...
                            mouseEvents: function () {
                                w.verbose("Binding mouse events"),
                                    w.is.multiple() && I.on("click" + q, P.label, w.event.label.click).on("click" + q, P.remove, w.event.remove.click),
                                    w.is.searchSelection()
                                        ...
                                        : ("click" == k.on
                                              ? I.on("click" + q, P.icon, w.event.icon.click).on("click" + q, w.event.test.toggle)
                                              : "hover" == k.on
                                              ? I.on("mouseenter" + q, w.delay.show).on("mouseleave" + q, w.delay.hide)
                                    ...
                                    w.is.multiple() && w.filterActive(),
                                        ...
                                        w.has.allResultsFiltered()
                                            ? k.onNoResults.call(X, t)
                                                ? k.allowAdditions || (w.verbose("All items filtered, showing message", t), w.add.message(S.noResults))
                                                : (w.verbose("All items filtered, hiding dropdown", t), w.hideMenu())
                                            : w.remove.message(),
                                ...
                                keydown: function (e) {
                                    ...
                                    if (i) {
                                        ...
                                        t == n.leftArrow
                                            ? (!g && !p) || c
                                                ? c &&
                                                  (e.shiftKey ? w.verbose("Adding previous label to selection") : (w.verbose("Selecting previous label"), o.removeClass(T.active)),
                                                  u && !l ? a.addClass(T.active) : a.prev(P.siblingLabel).addClass(T.active).end(),
                                                  e.preventDefault())
                                                : (w.verbose("Selecting previous label"), o.last().addClass(T.active))
                                            : t == n.rightArrow
                                            ? (g && !c && o.first().addClass(T.active),
                                              c &&
                                                  (e.shiftKey ? w.verbose("Adding next label to selection") : (w.verbose("Selecting next label"), o.removeClass(T.active)),
                                                  d ? (f ? (m ? o.removeClass(T.active) : w.focusSearch()) : l ? a.next(P.siblingLabel).addClass(T.active) : a.addClass(T.active)) : a.next(P.siblingLabel).addClass(T.active),
                                                  e.preventDefault()))
                                            : t == n.deleteKey || t == n.backspace
                                            ? c
                                                ? (w.verbose("Removing active labels"), d && f && !m && w.focusSearch(), a.last().next(P.siblingLabel).addClass(T.active), w.remove.activeLabels(a), e.preventDefault())
                                                : p && !c && t == n.backspace && (w.verbose("Removing last label on input backspace"), (a = o.last().addClass(T.active)), w.remove.activeLabels(a))
                            ...
                            keydown: function (e) {
                                ...
                                if (i) {
                                    ...
                                    if (w.is.visible()) {
                                        if (
                                            ((t == n.enter || h) &&
                                                (t == n.enter && g && m && !k.allowCategorySelection
                                                    ? (w.verbose("Pressed enter on unselectable category, opening sub menu"), (t = n.rightArrow))
                                                    : p && (w.verbose("Selecting item from keyboard shortcut", c), w.event.item.click.call(c, e), w.is.searchSelection() && w.remove.searchTerm()),
                                                e.preventDefault()),
                                            t == n.leftArrow &&
                                                ((a = d[0] !== U[0]), a && (w.verbose("Left key pressed, closing sub-menu"), w.animate.hide(!1, d), c.removeClass(T.selected), d.closest(P.item).addClass(T.selected), e.preventDefault())),
                                            t == n.rightArrow && m && (w.verbose("Right key pressed, opening sub-menu"), w.animate.show(!1, u), c.removeClass(T.selected), u.find(P.item).eq(0).addClass(T.selected), e.preventDefault()),
                                            t == n.upArrow)
                                        ) {
                                            if (((o = g && f ? c.prevAll(P.item + ":not(" + P.unselectable + ")").eq(0) : W.eq(0)), l.index(o) < 0))
                                                return w.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                        ...
                                        if (t == n.downArrow) {
                                            if (((o = g && f ? (o = c.nextAll(P.item + ":not(" + P.unselectable + ")").eq(0)) : W.eq(0)), 0 === o.length))
                                                return w.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                            ...
                            selectAction: function (t, n) {
                                w.verbose("Determining action", k.action),
                                    e.isFunction(w.action[k.action])
                                        ? (w.verbose("Triggering preset action", k.action, t, n), w.action[k.action].call(this, t, n))
                                        : e.isFunction(k.action)
                                        ? (w.verbose("Triggering user action", k.action, t, n), k.action.call(this, t, n))
                        ...
                        get: {
                            ...
                            choiceText: function (t, n) {
                                return (
                                    ...
                                    t
                                        ? (t.find(P.menu).length > 0 && (w.verbose("Retreiving text of element with sub-menu"), (t = t.clone()), t.find(P.menu).remove(), t.find(P.menuIcon).remove()),
                            ...
                            selectValues: function () {
                                ...
                                return (
                                    ...
                                    k.placeholder && "auto" !== k.placeholder && (w.debug("Setting placeholder value to", k.placeholder), (t.placeholder = k.placeholder)),
                                    k.sortSelect
                            ...
                            item: function (t, n) {
                                var o,
                                    ...
                                    r = !1;
                                return (
                                    (t = t !== i ? t : w.get.values() !== i ? w.get.values() : w.get.text()),
                            ...
                            maxSelections: function (e) {
                                return k.maxSelections
                                    ? ((e = e !== i ? e : w.get.selectionCount()),
                                      e >= k.maxSelections
                                          ? (w.debug("Maximum selection count reached"), k.useLabels && (W.addClass(T.filtered), w.add.message(S.maxSelections)), !0)
                                          : (w.verbose("No longer at maximum selection count"), w.remove.message(), w.remove.filteredItem(), w.is.searchSelection() && w.filterItems(), !1))
                                    : !0;
                            },
                        },
                        restore: {
                        ...
                        scrollPage: function (e, t) {
                            ...
                            (o = "up" == e ? f.index(a) - u : f.index(a) + u),
                                ...
                                i.length > 0 && (w.debug("Scrolling page", e, i), a.removeClass(T.selected), i.addClass(T.selected), r.scrollTop(d));
                        },
                        set: {
                            filtered: function () {
                                var e = w.is.multiple(),
                                    ...
                                    r = "" !== i;
                                e && o && (w.verbose("Adjusting input width", a, k.glyphWidth), M.css("width", a)),
                                    o || (n && r) ? (w.verbose("Hiding placeholder text"), N.addClass(T.filtered)) : (!e || (n && !r)) && (w.verbose("Showing placeholder text"), N.removeClass(T.filtered));
                            },
                            loading: function () {
                            ...
                            tabbable: function () {
                                w.has.search()
                                    ? (w.debug("Added tabindex to searchable dropdown"), M.val("").attr("tabindex", 0), U.attr("tabindex", -1))
                                    : (w.debug("Added tabindex to dropdown"), I.attr("tabindex") || (I.attr("tabindex", 0), U.attr("tabindex", -1)));
                            },
                            initialLoad: function () {
                            ...
                            scrollPosition: function (e, t) {
                                ...
                                (e = e || w.get.selectedItem()),
                                    ...
                                    e &&
                                        ...
                                        (r = e.offset().top),
                                        (a = c - s + r),
                                        t || ((l = n.height()), (d = a + f > c + l), (u = c > a - f)),
                            ...
                            text: function (e) {
                                "select" !== k.action &&
                                    ("combo" == k.action
                                        ? (w.debug("Changing combo button text", e, H), k.preserveHTML ? H.html(e) : H.text(e))
                                        : (e !== w.get.placeholderText() && N.removeClass(T.placeholder), w.debug("Changing text", e, N), N.removeClass(T.filtered), k.preserveHTML ? N.html(e) : N.text(e)));
                            },
                            selectedLetter: function (t) {
                                var n,
                                    ...
                                    a = !1;
                                o && ((n = i.nextAll(W).eq(0)), w.has.firstLetter(n, t) && (a = n)),
                                    a ||
                                        W.each(function () {
                            ...
                            value: function (e, t, n) {
                                ...
                                if (o) {
                                    ...
                                    w.is.single() && w.has.selectInput() && w.can.extendSelect() && (w.debug("Adding user option", e), w.add.optionValue(e)),
                                        ...
                                        (Q = !0),
                                        L.val(e),
                                        k.fireOnInit === !1 && w.is.initialLoad() ? w.debug("Input native change event ignored on initial load") : L.trigger("change"),
                                        (Q = !1);
                            ...
                            selected: function (t, n) {
                                var i = w.is.multiple();
                                (n = k.allowAdditions ? n || w.get.itemWithAdditions(t) : n || w.get.item(t)),
                                    n &&
                                        (w.debug("Setting selected menu item to", n),
                                        w.is.single() ? (w.remove.activeItem(), w.remove.selectedItem()) : k.useLabels && w.remove.selectedItem(),
                                        n.each(function () {
                                            var t = e(this),
                                            ...
                                            i
                                                ? !s || c
                                                    ? (k.apiSettings && k.saveRemoteData && w.save.remoteData(o, a),
                                                      k.useLabels
                                                          ? (w.add.value(a, o, t), w.add.label(a, o, l), w.set.activeItem(t), w.filterActive(), w.select.nextAvailable(n))
                                                          : (w.add.value(a, o, t), w.set.text(w.add.variables(S.count)), w.set.activeItem(t)))
                                                    : r || (w.debug("Selected active value, removing label"), w.remove.selected(a))
                                                : (k.apiSettings && k.saveRemoteData && w.save.remoteData(o, a), w.set.text(o), w.set.value(a, o, t), t.addClass(T.active).addClass(T.selected));
                                        }));
                            },
                        },
                        add: {
                            label: function (t, n, i) {
                                ...
                                return (
                                    (o = e("<a />").addClass(T.label).attr("data-value", t).html(O.label(t, n))),
                                    (o = k.onLabelCreate.call(o, t, n)),
                                    w.has.label(t)
                                        ? void w.debug("Label already exists, skipping", t)
                                        : (k.label.variation && o.addClass(k.label.variation),
                                          void (i === !0
                                              ? (w.debug("Animating in label", o), o.addClass(T.hidden).insertBefore(a).transition(k.label.transition, k.label.duration))
                                              : (w.debug("Adding selection label", o), o.insertBefore(a))))
                                );
                            },
                            message: function (t) {
                            ...
                            optionValue: function (t) {
                                var n = L.find('option[value="' + t + '"]'),
                                    i = n.length > 0;
                                i ||
                                    (x && (x.disconnect(), w.verbose("Temporarily disconnecting mutation observer", t)),
                                    w.is.single() && (w.verbose("Removing previous user addition"), L.find("option." + T.addition).remove()),
                                    e("<option/>").prop("value", t).addClass(T.addition).html(t).appendTo(L),
                            ...
                            userSuggestion: function (e) {
                                ...
                                if (!k.useLabels || !w.has.maxSelections()) {
                                    ...
                                    W.removeClass(T.selected),
                                        a
                                            ? ((t = k.templates.addition(w.add.variables(S.addResult, e))),
                                              n
                                                  .html(t)
                                                  .attr("data-" + D.value, e)
                                                  .attr("data-" + D.text, e)
                                                  ...
                                                  .addClass(T.selected),
                                              w.verbose("Replacing user suggestion with new value", n))
                                            : ((n = w.create.userChoice(e)), n.prependTo(U).addClass(T.selected), w.verbose("Adding item choice to menu corresponding with user choice addition", n));
                                }
                            },
                            variables: function (e, t) {
                                ...
                                return (
                                    ...
                                    a && ((n = w.get.selectionCount()), (e = e.replace("{maxCount}", k.maxSelections))),
                            ...
                            value: function (t, n, i) {
                                ...
                                return "" === t
                                    ...
                                    : (e.isArray(a) ? ((o = a.concat([t])), (o = w.get.uniqueArray(o))) : (o = [t]),
                                      w.has.selectInput() ? w.can.extendSelect() && (w.debug("Adding value to select", t, o, L), w.add.optionValue(t)) : ((o = o.join(k.delimiter)), w.debug("Setting hidden input to delimited value", o, L)),
                                      k.fireOnInit === !1 && w.is.initialLoad() ? w.verbose("Skipping onadd callback on initial load", k.onAdd) : k.onAdd.call(X, t, n, i),
                                      w.set.value(o, t, n, i),
                        ...
                        remove: {
                            ...
                            optionValue: function (e) {
                                ...
                                n &&
                                    ...
                                    (x && (x.disconnect(), w.verbose("Temporarily disconnecting mutation observer", e)),
                                    t.remove(),
                            ...
                            selected: function (t, n) {
                                return (n = k.allowAdditions ? n || w.get.itemWithAdditions(t) : n || w.get.item(t))
                                    ? void n.each(function () {
                                          ...
                                          w.is.multiple()
                                              ? k.useLabels
                                                  ...
                                                  : (w.remove.value(i, n, t), 0 === w.get.selectionCount() ? w.set.placeholderText() : w.set.text(w.add.variables(S.count)))
                            ...
                            value: function (e, t, n) {
                                var i,
                                    o = w.get.values();
                                w.has.selectInput()
                                    ? (w.verbose("Input is <select> removing selected option", e), (i = w.remove.arrayValue(e, o)), w.remove.optionValue(e))
                                    : (w.verbose("Removing from delimited values", e), (i = w.remove.arrayValue(e, o)), (i = i.join(k.delimiter))),
                                    k.fireOnInit === !1 && w.is.initialLoad() ? w.verbose("No callback on initial load", k.onRemove) : k.onRemove.call(X, e, t, n),
                                    w.set.value(i, t, n),
                            ...
                            tabbable: function () {
                                w.has.search()
                                    ? (w.debug("Searchable dropdown initialized"), M.attr("tabindex", "-1"), U.attr("tabindex", "-1"))
                                    : (w.debug("Simple selection dropdown initialized"), I.attr("tabindex", "-1"), U.attr("tabindex", "-1"));
                            },
                        },
                        has: {
                            search: function () {
                        ...
                        is: {
                            ...
                            onScreen: function (e) {
                                ...
                                return (
                                    n.addClass(T.loading),
                                    (t = { context: { scrollTop: z.scrollTop(), height: z.outerHeight() }, menu: { offset: n.offset(), height: n.outerHeight() } }),
                                    (o = { above: t.context.scrollTop <= t.menu.offset.top - t.menu.height, below: t.context.scrollTop + t.context.height >= t.menu.offset.top + t.menu.height }),
                                    o.below
                                        ? (w.verbose("Dropdown can fit in context downward", o), (i = !0))
                                        : o.below || o.above
                                        ? (w.verbose("Dropdown cannot fit below, opening upward", o), (i = !1))
                                        : (w.verbose("Dropdown cannot fit in either direction, favoring downward", o), (i = !0)),
                                    n.removeClass(T.loading),
                                    i
                                );
                            },
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                k.performance && ((t = new Date().getTime()), (i = u || t), (n = t - i), (u = t), d.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: X, "Execution Time": n })),
                        ...
                        invoke: function (t, n, o) {
                            ...
                            return (
                                ...
                                e.isArray(a) ? a.push(c) : a !== i ? (a = [a, c]) : c !== i && (a = c),
                                s
                            );
                        },
                    }),
            ...
            (e.fn.embed.settings = {
                ...
                sources: {
                    youtube: {
                        ...
                        parameters: function (e) {
                            return { autohide: !e.brandedUI, autoplay: e.autoplay, color: e.colors || i, hq: e.hd, jsapi: e.api, modestbranding: !e.brandedUI };
                        },
                    },
                    vimeo: {
                        name: "vimeo",
                        ...
                        parameters: function (e) {
                            return { api: e.api, autoplay: e.autoplay, byline: e.brandedUI, color: e.colors || i, portrait: e.brandedUI, title: e.brandedUI };
                        },
                    },
                },
                templates: {
    ...
    (function (e, t, n, i) {
        ...
        (e.fn.modal = function (o) {
                    ...
                    (T = {
                        ...
                        create: {
                            dimmer: function () {
                                ...
                                return (
                                    S.inverted && (n.variation = n.variation !== i ? n.variation + " inverted" : "inverted"),
                                    e.fn.dimmer === i
                                        ? void T.error(E.dimmer)
                                        : (T.debug("Creating dimmer with settings", n),
                                          (y = q.dimmer(n)),
                                          S.detachable ? (T.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", O)) : T.set.undetached(),
                                ...
                                T.is.animating() || !T.is.active()
                                    ? (T.showDimmer(),
                                      ...
                                      !S.allowMultiple && T.others.active()
                                          ...
                                          : (S.onShow.call(I),
                                            S.transition && e.fn.transition !== i && O.transition("is supported")
                        ...
                        hideModal: function (t, n) {
                            return (
                                ...
                                S.onHide.call(I, e(this)) === !1
                                    ? void T.verbose("Hide callback returned false cancelling hide")
                                    : void (
                                          (T.is.animating() || T.is.active()) &&
                                          (S.transition && e.fn.transition !== i && O.transition("is supported")
                                              ? (T.remove.active(),
                        ...
                        cacheSizes: function () {
                            var o = O.outerHeight();
                            (T.cache === i || 0 !== o) && (T.cache = { pageHeight: e(n).outerHeight(), height: o + S.offset, contextHeight: "body" == S.context ? e(t).height() : y.height() }),
                        ...
                        set: {
                            ...
                            position: function () {
                                T.verbose("Centering modal on page", T.cache), T.can.fit() ? O.css({ top: "", marginTop: -(T.cache.height / 2) }) : O.css({ marginTop: "", top: c.scrollTop() });
                            },
                            undetached: function () {
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                S.performance && ((t = new Date().getTime()), (i = d || t), (n = t - i), (d = t), f.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: I, "Execution Time": n })),
                        ...
                        g ? (z === i && T.initialize(), T.invoke(m)) : (z !== i && z.invoke("destroy"), T.initialize());
                }),
                a !== i ? a : this
            );
        }),
            (e.fn.modal.settings = {
                ...
                className: { active: "active", animating: "animating", blurring: "blurring", scrolling: "scrolling", undetached: "undetached" },
            });
    })(jQuery, window, document),
    (function (e, t, n, i) {
        "use strict";
                ...
                a.each(function () {
                    ...
                    (a = {
                        ...
                        should: {
                            show: function () {
                                return f.persist
                                    ...
                                    ? (a.debug("Stored value is not set, can show nag", a.storage.get(f.key)), !0)
                                    : (a.debug("Stored value is set, cannot show nag", a.storage.get(f.key)), !1);
                            },
                        },
                        get: {
                            ...
                            get: function (n, o) {
                                ...
                                return (
                                    "localstorage" == f.storageMethod && t.localStorage !== i
                                        ...
                                        : "sessionstorage" == f.storageMethod && t.sessionStorage !== i
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                f.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: x, "Execution Time": n })),
                                    clearTimeout(a.performance.timer),
                                    (a.performance.timer = setTimeout(a.performance.display, 500));
                            },
                            display: function () {
            ...
            return (
                r.each(function () {
                    ...
                    (y = {
                        ...
                        refresh: function () {
                            x.popup ? (n = e(x.popup).eq(0)) : x.inline && ((n = P.nextAll(C.popup).eq(0)), (x.popup = n)),
                                x.popup
                                    ? (n.addClass(w.loading),
                                      (r = y.get.offsetParent()),
                                      n.removeClass(w.loading),
                                      x.movePopup && y.has.popup() && y.get.offsetParent(n)[0] !== r[0] && (y.debug("Moving popup to the same offset parent as activating element"), n.detach().appendTo(r)))
                                    : (r = x.inline ? y.get.offsetParent(P) : y.has.popup() ? y.get.offsetParent(n) : l),
                                r.is("html") && r[0] !== l[0] && (y.debug("Setting page as offset parent"), (r = l)),
                        ...
                        create: function () {
                            ...
                            t || o || i
                                ? (y.debug("Creating pop-up html"),
                                  ...
                                  (n = e("<div/>").addClass(w.popup).data(T.activator, R).html(t)),
                                  x.inline ? (y.verbose("Inserting popup element inline", n), n.insertAfter(R)) : (y.verbose("Appending popup element to body", n), n.appendTo(E)),
                                  y.refresh(),
                                  y.set.variation(),
                                  x.hoverable && y.bind.popup(),
                                  x.onCreate.call(n, j))
                                : 0 !== P.next(C.popup).length
                                ? (y.verbose("Pre-existing popup found"), (x.inline = !0), (x.popups = P.next(C.popup).data(T.activator, R)), y.refresh(), x.hoverable && y.bind.popup())
                                : x.popup
                                ? (e(x.popup).data(T.activator, R), y.verbose("Used popup specified in settings"), y.refresh(), x.hoverable && y.bind.popup())
                        ...
                        animate: {
                            show: function (t) {
                                (t = e.isFunction(t) ? t : function () {}),
                                    x.transition && e.fn.transition !== i && R.transition("is supported")
                                        ? (y.set.visible(),
                                          n.transition({
                            ...
                            hide: function (t) {
                                return (
                                    ...
                                    x.onHide.call(n, j) === !1
                                        ? void y.debug("onHide callback returned false, cancelling popup animation")
                                        : void (x.transition && e.fn.transition !== i && R.transition("is supported")
                                              ? n.transition({
                        ...
                        get: {
                            ...
                            calculations: function () {
                                ...
                                return (
                                    (a = {
                                        target: { element: P[0], width: P.outerWidth(), height: P.outerHeight(), top: o.top, left: o.left, margin: {} },
                                    ...
                                    x.setFluidWidth && y.is.fluid() && ((a.container = { width: n.parent().outerWidth() }), (a.popup.width = a.container.width)),
                                    (a.target.margin.top = x.inline ? parseInt(t.getComputedStyle(i).getPropertyValue("margin-top"), 10) : 0),
                                    (a.target.margin.left = x.inline ? (y.is.rtl() ? parseInt(t.getComputedStyle(i).getPropertyValue("margin-right"), 10) : parseInt(t.getComputedStyle(i).getPropertyValue("margin-left"), 10)) : 0),
                                    (e = a.screen),
                                    (a.boundary = { top: e.scroll.top, bottom: e.scroll.top + e.height, left: e.scroll.left, right: e.scroll.left + e.width }),
                                    a
                                );
                            },
                            id: function () {
                            ...
                            distanceFromBoundary: function (e, t) {
                                ...
                                return (
                                    ...
                                    (n = t.popup),
                                    (i = t.boundary),
                                    e && ((o = { top: e.top - i.top, left: e.left - i.left, right: i.right - (e.left + n.width), bottom: i.bottom - (e.top + n.height) }), y.verbose("Distance from boundaries determined", e, o)),
                                    o
                                );
                            },
                            ...
                            nextPosition: function (e) {
                                var t = e.split(" "),
                                    ...
                                    u = !1;
                                return (
                                    O || (y.verbose("All available positions available"), (O = y.get.positions())),
                                    y.debug("Recording last position tried", e),
                                    (O[e] = !0),
                                    "opposite" === x.prefer && ((u = [o[n], i]), (u = u.join(" ")), (c = O[u] === !0), y.debug("Trying opposite strategy", u)),
                                    "adjacent" === x.prefer && s && ((u = [n, a[i]]), (u = u.join(" ")), (l = O[u] === !0), y.debug("Trying adjacent strategy", u)),
                        ...
                        set: {
                            position: function (e, t) {
                                ...
                                switch (
                                    ...
                                    F == x.maxSearchDepth && "string" == typeof x.lastResort && (e = x.lastResort),
                                    e)
                                ) {
                                    case "top left":
                                        ...
                                        break;
                                    case "top center":
                                        l = { bottom: c.height - r.top + a, left: r.left + r.width / 2 - s.width / 2 + o, top: "auto", right: "auto" };
                                        break;
                                    case "top right":
                                        l = { bottom: c.height - r.top + a, right: c.width - r.left - r.width - o, top: "auto", left: "auto" };
                                        break;
                                    case "left center":
                                        l = { top: r.top + r.height / 2 - s.height / 2 + o, right: c.width - r.left + a, left: "auto", bottom: "auto" };
                                        break;
                                    case "right center":
                                        l = { top: r.top + r.height / 2 - s.height / 2 + o, left: r.left + r.width + a, bottom: "auto", right: "auto" };
                                        break;
                                    case "bottom left":
                                        l = { top: r.top + r.height + a, left: r.left + o, bottom: "auto", right: "auto" };
                                        break;
                                    case "bottom center":
                                        l = { top: r.top + r.height + a, left: r.left + r.width / 2 - s.width / 2 + o, bottom: "auto", right: "auto" };
                                        break;
                                    case "bottom right":
                                        l = { top: r.top + r.height + a, right: c.width - r.left - r.width - o, left: "auto", bottom: "auto" };
                                }
                                if (
                                    (l === i && y.error(k.invalidPosition, e),
                                    y.debug("Calculated popup positioning values", l),
                                    n.css(l).removeClass(w.position).addClass(e).addClass(w.loading),
                                    (u = y.get.popupOffset()),
                        ...
                        bind: {
                            events: function () {
                                y.debug("Binding popup events to module"),
                                    ...
                                    "hover" == x.on && d && R.on("touchstart" + A, y.event.touchstart),
                                    y.get.startEvent() && R.on(y.get.startEvent() + A, y.event.start).on(y.get.endEvent() + A, y.event.end),
                            ...
                            close: function () {
                                (x.hideOnScroll === !0 || ("auto" == x.hideOnScroll && "click" != x.on)) && (s.one(y.get.scrollEvent() + v, y.event.hideGracefully), E.one(y.get.scrollEvent() + v, y.event.hideGracefully)),
                                    "hover" == x.on &&
                                        q &&
                        ...
                        unbind: {
                            close: function () {
                                (x.hideOnScroll === !0 || ("auto" == x.hideOnScroll && "click" != x.on)) && (s.off("scroll" + v, y.hide), E.off("scroll" + v, y.hide)),
                                    "hover" == x.on && q && (s.off("touchstart" + v), (q = !1)),
                                    "click" == x.on && x.closable && (y.verbose("Removing close event from document"), s.off("click" + v));
                            },
                        },
                        has: {
                            popup: function () {
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                x.performance && ((t = new Date().getTime()), (i = f || t), (n = t - i), (f = t), m.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: j, "Execution Time": n })),
            ...
            (e.fn.popup.settings = {
                ...
                templates: {
                    ...
                    popup: function (t) {
                        ...
                        return (
                            typeof t !== i &&
                                (typeof t.title !== i && t.title && ((t.title = o(t.title)), (n += '<div class="header">' + t.title + "</div>")),
                                typeof t.content !== i && t.content && ((t.content = o(t.content)), (n += '<div class="content">' + t.content + "</div>"))),
                            n
                        );
                    },
                },
    ...
    (function (e, t, n, i) {
        ...
        (e.fn.progress = function (t) {
                ...
                a.each(function () {
                    ...
                    (f = {
                        ...
                        read: {
                            ...
                            settings: function () {
                                m.total !== !1 && (f.debug("Current total set in settings", m.total), f.set.total(m.total)),
                                    m.value !== !1 && (f.debug("Current value set in settings", m.value), f.set.value(m.value), f.set.progress(f.value)),
                                    m.percent !== !1 && (f.debug("Current percent set in settings", m.percent), f.set.percent(m.percent));
                            },
                        },
                        increment: function (e) {
                            var t, n, i;
                            f.has.total()
                                ? ((n = f.get.value()), (e = e || 1), (i = n + e), (t = f.get.total()), f.debug("Incrementing value", n, i, t), i > t && (f.debug("Value cannot increment above total", t), (i = t)))
                                : ((n = f.get.percent()), (e = e || f.get.randomValue()), (i = n + e), (t = 100), f.debug("Incrementing percentage by", n, i), i > t && (f.debug("Value cannot increment above 100 percent"), (i = t))),
                                f.set.progress(i);
                        },
                        ...
                        set: {
                            ...
                            percent: function (e) {
                                (e = "string" == typeof e ? +e.replace("%", "") : e),
                                    ...
                                    (f.percent = e),
                                    f.has.total() ||
                                        ((f.value = m.precision > 0 ? Math.round((e / 100) * f.total * (10 * m.precision)) / (10 * m.precision) : Math.round((e / 100) * f.total * 10) / 10),
                                ...
                                (e = e !== i ? e : f.percent),
                                    100 === e
                                        ? !m.autoSuccess || f.is.warning() || f.is.error()
                                            ? (f.verbose("Reached 100% removing active state"), f.remove.active())
                                            : (f.set.success(), f.debug("Automatically triggering success at 100%"))
                                        : e > 0
                                        ? (f.verbose("Adjusting active progress bar label", e), f.set.active())
                            ...
                            barLabel: function (e) {
                                e !== i
                                    ...
                                    ? (f.debug("Adding ratio to bar label"), k.text(f.get.text(m.text.ratio)))
                                    : "percent" == m.label && (f.debug("Adding percentage to bar label"), k.text(f.get.text(m.text.percent)));
                            },
                            active: function (e) {
                                (e = e || m.text.active),
                            ...
                            progress: function (e) {
                                ...
                                n === !1 && f.error(b.nonNumeric, e),
                                    f.has.total()
                                        ? (f.set.value(n), (t = (n / f.total) * 100), f.debug("Calculating percent complete from total", t), f.set.percent(t))
                                        : ((t = n), f.debug("Setting value to exact percentage value", t), f.set.percent(t));
                            },
                        },
                        setting: function (t, n) {
                            if ((f.debug("Changing setting", t, n), e.isPlainObject(t))) e.extend(!0, m, t);
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                m.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: S, "Execution Time": n })),
                                    clearTimeout(f.performance.timer),
                                    (f.performance.timer = setTimeout(f.performance.display, 500));
                            },
                            display: function () {
            ...
            (e.fn.progress.settings = {
                ...
                error: { method: "The method you called is not defined.", nonNumeric: "Progress value is non numeric", tooHigh: "Value specified is above 100%", tooLow: "Value specified is below 0%" },
                ...
                o.each(function () {
                    ...
                    (d = {
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                f.performance && ((t = new Date().getTime()), (i = r || t), (n = t - i), (r = t), s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: y, "Execution Time": n })),
    ...
    (function (e, t, n, i) {
        ...
        (e.fn.search = function (o) {
                    ...
                    (m = {
                        ...
                        bind: {
                            events: function () {
                                m.verbose("Binding events to search"),
                                    g.automatic && (T.on(m.get.inputEvent() + w, y.prompt, m.event.input), S.attr("autocomplete", "off")),
                        ...
                        event: {
                            ...
                            result: {
                                ...
                                click: function (n) {
                                    ...
                                    return e.isFunction(g.onSelect) && g.onSelect.call(R, u, l) === !1
                                        ? void m.debug("Custom onSelect callback cancelled default select action")
                                        : (m.hideResults(), c && m.set.value(c), void (r && (m.verbose("Opening search link found in result", a), "_blank" == s || n.ctrlKey ? t.open(r) : (t.location.href = r))));
                                },
                            },
                        },
                            ...
                            result: function (t, n) {
                                ...
                                return (
                                    ...
                                    "category" === g.type
                                        ...
                                        : (m.debug("Finding result in results object", t), (a = m.search.object(t, n, o)[0])),
                                    a || !1
                                );
                            },
                        },
                        ...
                        query: function () {
                            ...
                            m.has.minimumCharacters()
                                ? n
                                    ? (m.debug("Reading result from cache", t), m.save.results(n.results), m.addResults(n.html), m.inject.id(n.results))
                                    : (m.debug("Querying for", t), e.isPlainObject(g.source) || e.isArray(g.source) ? m.search.local(t) : m.can.useAPI() ? m.search.remote(t) : m.error(x.source), g.onSearchQuery.call(R, t))
                                : m.hideResults();
                        },
                        search: {
                            local: function (e) {
                        ...
                        parse: {
                            response: function (e, t) {
                                ...
                                m.verbose("Parsing server response", e),
                                    e !== i && t !== i && e[b.results] !== i && (m.addResults(n), m.inject.id(e[b.results]), m.write.cache(t, { html: n, results: e[b.results] }), m.save.results(e[b.results]));
                            },
                        },
                        cancel: {
                            query: function () {
                        ...
                        showResults: function () {
                            m.is.visible() ||
                                (m.can.transition()
                                    ? (m.debug("Showing results with css animations"), D.transition({ animation: g.transition + " in", debug: g.debug, verbose: g.verbose, duration: g.duration, queue: !0 }))
                                    : (m.debug("Showing results with javascript"), D.stop().fadeIn(g.duration, g.easing)),
                                g.onResultsOpen.call(D));
                        },
                        hideResults: function () {
                            m.is.visible() &&
                                (m.can.transition()
                                    ? (m.debug("Hiding results with css animations"), D.transition({ animation: g.transition + " out", debug: g.debug, verbose: g.verbose, duration: g.duration, queue: !0 }))
                                    : (m.debug("Hiding results with javascript"), D.stop().fadeOut(g.duration, g.easing)),
                        ...
                        generateResults: function (t) {
                            ...
                            return (
                                i || o
                                    ? (g.maxResults > 0 && (i ? "standard" == g.type && m.error(x.maxResults) : (t[b.results] = t[b.results].slice(0, g.maxResults))), e.isFunction(n) ? (a = n(t, b)) : m.error(x.noTemplate, !1))
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                g.performance && ((t = new Date().getTime()), (i = c || t), (n = t - i), (c = t), l.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: R, "Execution Time": n })),
                                    clearTimeout(m.performance.timer),
                                    (m.performance.timer = setTimeout(m.performance.display, 500));
                            },
                            display: function () {
            ...
            (e.fn.search.settings = {
                ...
                className: { active: "active", empty: "empty", focus: "focus", loading: "loading", results: "results", pressed: "down" },
                error: {
                ...
                selector: { prompt: ".prompt", searchButton: ".search.button", results: ".results", category: ".category", result: ".result", title: ".title, .name" },
                templates: {
                    escape: function (e) {
                        var t = /[&<>"'`]/g,
                            n = /[&<>"'`]/,
            ...
            return (
                r.each(function () {
                    ...
                    (g = {
                        ...
                        set: {
                            ...
                            duration: function (e) {
                                (e = e || h.duration),
                                    ...
                                    (h.duration || 0 === h.duration) && T.add(S).css({ "-webkit-transition-duration": e, "-moz-transition-duration": e, "-ms-transition-duration": e, "-o-transition-duration": e, "transition-duration": e });
                            },
                        ...
                        flip: {
                            up: function () {
                                return !g.is.complete() || g.is.animating() || h.allowRepeats
                                    ? void (g.is.animating() ? g.queue("flip up") : (g.debug("Flipping up", m), g.set.stageSize(), g.stage.above(), g.animate(g.get.transform.up())))
                                    : void g.debug("Side already visible", m);
                            },
                            down: function () {
                                return !g.is.complete() || g.is.animating() || h.allowRepeats
                                    ? void (g.is.animating() ? g.queue("flip down") : (g.debug("Flipping down", m), g.set.stageSize(), g.stage.below(), g.animate(g.get.transform.down())))
                                    : void g.debug("Side already visible", m);
                            },
                            left: function () {
                                return !g.is.complete() || g.is.animating() || h.allowRepeats
                                    ? void (g.is.animating() ? g.queue("flip left") : (g.debug("Flipping left", m), g.set.stageSize(), g.stage.left(), g.animate(g.get.transform.left())))
                                    : void g.debug("Side already visible", m);
                            },
                            right: function () {
                                return !g.is.complete() || g.is.animating() || h.allowRepeats
                                    ? void (g.is.animating() ? g.queue("flip right") : (g.debug("Flipping right", m), g.set.stageSize(), g.stage.right(), g.animate(g.get.transform.right())))
                                    : void g.debug("Side already visible", m);
                            },
                            over: function () {
                                return !g.is.complete() || g.is.animating() || h.allowRepeats
                                    ? void (g.is.animating() ? g.queue("flip over") : (g.debug("Flipping over", m), g.set.stageSize(), g.stage.behind(), g.animate(g.get.transform.over())))
                                    : void g.debug("Side already visible", m);
                            },
                            back: function () {
                                return !g.is.complete() || g.is.animating() || h.allowRepeats
                                    ? void (g.is.animating() ? g.queue("flip back") : (g.debug("Flipping back", m), g.set.stageSize(), g.stage.behind(), g.animate(g.get.transform.back())))
                                    : void g.debug("Side already visible", m);
                            },
                        },
                        get: {
                        ...
                        stage: {
                            above: function () {
                                var e = { origin: (t.outerHeight(!0) - m.outerHeight(!0)) / 2, depth: { active: m.outerHeight(!0) / 2, next: t.outerHeight(!0) / 2 } };
                                g.verbose("Setting the initial animation position as above", m, e),
                                    T.css({ transform: "translateZ(-" + e.depth.active + "px)" }),
                                    t.css({ transform: "rotateY(0deg) translateZ(" + e.depth.active + "px)" }),
                                    m.addClass(x.animating).css({ top: e.origin + "px", transform: "rotateX(90deg) translateZ(" + e.depth.next + "px)" });
                            },
                            below: function () {
                                var e = { origin: (t.outerHeight(!0) - m.outerHeight(!0)) / 2, depth: { active: m.outerHeight(!0) / 2, next: t.outerHeight(!0) / 2 } };
                            ...
                            left: function () {
                                ...
                                g.verbose("Setting the initial animation position as left", m, n),
                                    ...
                                    t.css({ transform: "rotateY(0deg) translateZ(" + n.depth.active + "px)" }),
                                    m.addClass(x.animating).css({ left: n.origin + "px", transform: "rotateY(-90deg) translateZ(" + n.depth.next + "px)" });
                            },
                            right: function () {
                                var e = { active: t.outerWidth(!0), next: m.outerWidth(!0) },
                                    n = { origin: (e.active - e.next) / 2, depth: { active: e.next / 2, next: e.active / 2 } };
                            ...
                            behind: function () {
                                var e = { active: t.outerWidth(!0), next: m.outerWidth(!0) },
                                    n = { origin: (e.active - e.next) / 2, depth: { active: e.next / 2, next: e.active / 2 } };
                                g.verbose("Setting the initial animation position as behind", m, n), t.css({ transform: "rotateY(0deg)" }), m.addClass(x.animating).css({ left: n.origin + "px", transform: "rotateY(-180deg)" });
                            },
                        },
                        setting: function (t, n) {
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                h.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: D, "Execution Time": n })),
                ...
                r.each(function () {
                    ...
                    (w = {
                        ...
                        bind: {
                            ...
                            scrollLock: function () {
                                k.scrollLock && (w.debug("Disabling page scroll"), s.on("DOMMouseScroll" + b, w.event.scroll)),
                            ...
                            inlineCSS: function () {
                                ...
                                o && (w.verbose("RTL detected, flipping widths"), (s.left = -n), (s.right = n)),
                                    ...
                                    w.is.ie() &&
                                        ("left" === a || "right" === a
                                            ? (w.debug("Adding CSS rules for animation distance", n),
                                              (t += " body.pushable > .ui.visible." + a + ".sidebar ~ .pusher:after {   -webkit-transform: translate3d(" + s[a] + "px, 0, 0);           transform: translate3d(" + s[a] + "px, 0, 0); }"))
                                            : ("top" === a || "bottom" == a) &&
                                              (t += " body.pushable > .ui.visible." + a + ".sidebar ~ .pusher:after {   -webkit-transform: translate3d(0, " + s[a] + "px, 0);           transform: translate3d(0, " + s[a] + "px, 0); }"),
                                        (t +=
                        ...
                        setup: {
                            ...
                            layout: function () {
                                0 === O.children(T.pusher).length && (w.debug("Adding wrapper element for sidebar"), w.error(R.pusher), (I = e('<div class="pusher" />')), O.children().not(T.omitted).not(q).wrapAll(I), w.refresh()),
                                    (0 === F.nextAll(T.pusher).length || F.nextAll(T.pusher)[0] !== I[0]) && (w.debug("Moved sidebar to correct parent element"), w.error(R.movedSidebar, z), F.detach().prependTo(O), w.refresh()),
                                    w.clear.cache(),
                                    w.set.pushable(),
                                    w.set.direction();
                            },
                        ...
                        get: {
                            ...
                            transition: function () {
                                var e,
                                    t = w.get.direction();
                                return (
                                    (e = w.is.mobile() ? ("auto" == k.mobileTransition ? k.defaultTransition.mobile[t] : k.mobileTransition) : "auto" == k.transition ? k.defaultTransition.computer[t] : k.transition),
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                k.performance && ((t = new Date().getTime()), (i = f || t), (n = t - i), (f = t), m.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: z, "Execution Time": n })),
                                    clearTimeout(w.performance.timer),
                                    (w.performance.timer = setTimeout(w.performance.display, 500));
                            },
                            display: function () {
                    ...
                    (g = {
                        ...
                        save: {
                            ...
                            positions: function () {
                                ...
                                (g.cache = {
                                    ...
                                    element: { margin: t.margin, top: t.offset.top - t.margin.top, left: t.offset.left, width: t.width, height: t.height, bottom: t.offset.top + t.height },
                        ...
                        set: {
                            ...
                            containerSize: function () {
                                ...
                                "HTML" === e || "body" == e
                                    ...
                                    : Math.abs(a.outerHeight() - g.cache.context.height) > p.jitter &&
                                      (g.debug("Context has padding, specifying exact height for container", g.cache.context.height), a.css({ height: g.cache.context.height }));
                            },
                            ...
                            size: function () {
                                0 !== g.cache.element.height &&
                                    ...
                                    (A.style.setProperty("width", g.cache.element.width + "px", "important"), A.style.setProperty("height", g.cache.element.height + "px", "important"));
                            },
                        },
                        is: {
                            top: function () {
                        ...
                        stick: function (e) {
                            ...
                            u &&
                                (g.is.initialPosition()
                                    ? e.top >= r.bottom
                                        ? (g.debug("Initial element position is bottom of container"), g.bindBottom())
                                        : e.top > o.top && (o.height + e.top - c >= r.bottom ? (g.debug("Initial element position is bottom of container"), g.bindBottom()) : (g.debug("Initial element position is fixed"), g.fixTop()))
                                    : g.is.fixed()
                                    ? g.is.top()
                                        ? e.top <= o.top
                                            ? (g.debug("Fixed element reached top of container"), g.setInitialPosition())
                                            : o.height + e.top - c >= r.bottom
                                            ? (g.debug("Fixed element reached bottom of container"), g.bindBottom())
                                            : l && (g.set.scroll(c), g.save.lastScroll(e.top), g.save.elementScroll(c))
                                        : g.is.bottom() &&
                                          (e.bottom - o.height <= o.top
                                              ? (g.debug("Bottom fixed rail has reached top of container"), g.setInitialPosition())
                                              : e.bottom >= r.bottom
                                              ? (g.debug("Bottom fixed rail has reached bottom of container"), g.bindBottom())
                                              : l && (g.set.scroll(c), g.save.lastScroll(e.top), g.save.elementScroll(c)))
                                    : g.is.bottom() &&
                                      (p.pushing
                                          ? g.is.bound() && e.bottom <= r.bottom && (g.debug("Fixing bottom attached element to bottom of browser."), g.fixBottom())
                                          : g.is.bound() && e.top <= r.bottom - o.height && (g.debug("Fixing bottom attached element to top of browser."), g.fixTop())));
                        },
                        bindTop: function () {
                            g.debug("Binding element to top of parent container"),
                                g.remove.offset(),
                                C.css({ left: "", top: "", marginBottom: "" }).removeClass(h.fixed).removeClass(h.bottom).addClass(h.bound).addClass(h.top),
                                p.onTop.call(A),
                                p.onUnstick.call(A);
                        },
                        bindBottom: function () {
                            g.debug("Binding element to bottom of parent container"),
                                g.remove.offset(),
                                C.css({ left: "", top: "" }).removeClass(h.fixed).removeClass(h.top).addClass(h.bound).addClass(h.bottom),
                                p.onBottom.call(A),
                                p.onUnstick.call(A);
                        },
                        ...
                        fixTop: function () {
                            g.debug("Fixing element to top of page"),
                                g.set.minimumSize(),
                                g.set.offset(),
                                C.css({ left: g.cache.element.left, bottom: "", marginBottom: "" }).removeClass(h.bound).removeClass(h.bottom).addClass(h.fixed).addClass(h.top),
                                p.onStick.call(A);
                        },
                        fixBottom: function () {
                            g.debug("Sticking element to bottom of page"),
                                g.set.minimumSize(),
                                g.set.offset(),
                                C.css({ left: g.cache.element.left, bottom: "", marginBottom: "" }).removeClass(h.bound).removeClass(h.top).addClass(h.fixed).addClass(h.bottom),
                                p.onStick.call(A);
                        },
                        unbind: function () {
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                p.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: A, "Execution Time": n })),
                                    clearTimeout(g.performance.timer),
                ...
                r.each(function () {
                    ...
                    (b = {
                        ...
                        determineTabs: function () {
                            var t;
                            "parent" === x.context
                                ? (D.closest(k.ui).length > 0 ? ((t = D.closest(k.ui)), b.verbose("Using closest UI element as parent", t)) : (t = D), (g = t.parent()), b.verbose("Determined parent element for creating context", g))
                                : x.context
                                ? ((g = e(x.context)), b.verbose("Using selector for tab context", x.context, g))
                                : (g = e("body")),
                                x.childrenOnly ? ((p = g.children(k.tabs)), b.debug("Searching tab context children for tabs", g, p)) : ((p = g.find(k.tabs)), b.debug("Searching tab context for tabs", g, p));
                        },
                        fix: {
                            callbacks: function () {
                                e.isPlainObject(o) &&
                                    (o.onTabLoad || o.onTabInit) &&
                                    (o.onTabLoad && ((o.onLoad = o.onTabLoad), delete o.onTabLoad, b.error(T.legacyLoad, o.onLoad)),
                                    o.onTabInit && ((o.onFirstLoad = o.onTabInit), delete o.onTabInit, b.error(T.legacyInit, o.onFirstLoad)),
                                ...
                                e.each(r, function (t, i) {
                                    ...
                                    if ((b.verbose("Looking for tab", i), m)) {
                                        if (
                                            ...
                                            p ? (u = !0) : ((c = r.slice(0, t + 2)), (l = b.utilities.arrayToPath(c)), (u = !b.is.tab(l)), u && b.verbose("Tab parameters found", c)),
                                            u && a)
                                        )
                                            return (
                                                o
                                                    ? (b.debug("Ignoring remote content on first tab load", f), (E = !1), b.cache.add(n, k.html()), b.activate.all(f), x.onFirstLoad.call(k[0], f, v, y), x.onLoad.call(k[0], f, v, y))
                                        ...
                                        if (((s = e("#" + n + ', a[name="' + n + '"]')), (f = s.closest("[data-tab]").data(w.tab)), (k = b.get.tabElement(f)), s && s.length > 0 && f))
                                            return (
                        ...
                        fetch: {
                            content: function (t, n) {
                                ...
                                (n = n || t),
                                    (a = b.cache.read(n)),
                                    x.cache && a
                                        ? (b.activate.tab(t), b.debug("Adding cached content", n), "once" == x.evaluateScripts ? b.update.content(t, a, !1) : b.update.content(t, a), x.onLoad.call(r[0], t, v, y))
                                        : l
                                        ? (b.set.loading(t), b.debug("Content is already loading", n))
                                        : e.api !== i
                                        ? ((o = e.extend(!0, {}, x.apiSettings, s)), b.debug("Retrieving remote content", n, o), b.set.loading(t), r.api(o))
                                        : b.error(T.api);
                            },
                        },
                        activate: {
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                x.performance && ((t = new Date().getTime()), (i = c || t), (n = t - i), (c = t), l.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: F, "Execution Time": n })),
                    ...
                    (C = {
                        initialize: function () {
                            (m = C.get.settings.apply(k, l)),
                                ...
                                f && (f = C.invoke(u)),
                                f === !1 && (C.verbose("Converted arguments into settings object", m), m.interval ? C.delay(m.animate) : C.animate(), C.instantiate());
                        },
                        instantiate: function () {
                        ...
                        animate: function (e) {
                            ...
                            if ((C.debug("Preparing animation", m.animation), C.is.animating())) {
                                if (m.queue)
                                    return (
                                        !m.allowRepeats && C.has.direction() && C.is.occurring() && C.queuing !== !0 ? C.debug("Animation is currently occurring, preventing queueing same animation", m.animation) : C.queue(m.animation), !1
                                    );
                        ...
                        get: {
                            settings: function (t, n, i) {
                                return "object" == typeof t
                                    ...
                                    : "function" == typeof i
                                    ? e.extend({}, e.fn.transition.settings, { animation: t, onComplete: i, duration: n })
                                    : "string" == typeof n || "number" == typeof n
                                    ? e.extend({}, e.fn.transition.settings, { animation: t, duration: n })
                                    : "object" == typeof n
                                    ? e.extend({}, e.fn.transition.settings, n, { animation: t })
                                    : "function" == typeof n
                                    ? e.extend({}, e.fn.transition.settings, { animation: t, onComplete: n })
                            ...
                            transition: function (t) {
                                ...
                                if (d === i || t) {
                                    if (
                                        ...
                                        (l = a.attr("class", n).removeAttr("style").removeClass(h.hidden).removeClass(h.visible).show().css("display")),
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                m.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: k, "Execution Time": n })),
                    ...
                    (h = {
                        ...
                        write: {
                            cachedResponse: function (n, o) {
                                return o && "" === o
                                    ...
                                    : (e.isPlainObject(o) && (o = JSON.stringify(o)), sessionStorage.setItem(n, o), void h.verbose("Storing cached response for url", n, o));
                            },
                        },
                        query: function () {
                                ...
                                f === !1
                                    ...
                                    : ((h.cancelled = !1),
                                      ...
                                      m || h.is.mocked()
                                          ? ((m = h.add.urlData(m)),
                                            m || h.is.mocked()
                                                ? ((a = e.extend(!0, {}, v, { type: v.method || v.type, data: g, url: v.base + m, beforeSend: v.beforeXHR, success: function () {}, failure: function () {}, complete: function () {} })),
                                                  h.debug("Querying URL", a.url),
                                                  h.verbose("Using AJAX settings", a),
                                                  "local" === v.cache && h.read.cachedResponse(m)
                                                      ? (h.debug("Response returned from local cache"), (h.request = h.create.request()), void h.request.resolveWith(E, [h.read.cachedResponse(m)]))
                                                      : void (v.throttle
                                                            ? v.throttleFirstRequest || h.timer
                                                                ? (h.debug("Throttling request", v.throttle),
                                                                  clearTimeout(h.timer),
                                                                  (h.timer = setTimeout(function () {
                                                                      h.timer && delete h.timer, h.debug("Sending throttled request", g, a.method), h.send.request();
                                                                  }, v.throttle)))
                                                                : (h.debug("Sending request", g, a.method), h.send.request(), (h.timer = setTimeout(function () {}, v.throttle)))
                                                            : (h.debug("Sending request", g, a.method), h.send.request())))
                                                : void 0)
                        ...
                        is: {
                            ...
                            validResponse: function (t) {
                                return ("json" !== v.dataType && "jsonp" !== v.dataType) || !e.isFunction(v.successTest)
                                    ? (h.verbose("Response is not JSON, skipping validation", v.successTest, t), !0)
                                    : (h.debug("Checking JSON returned success", v.successTest, t), v.successTest(t) ? (h.debug("Response passed success test", t), !0) : (h.debug("Response failed success test", t), !1));
                            },
                        },
                        was: {
                            cancelled: function () {
                        ...
                        add: {
                                        ...
                                        o &&
                                            ...
                                            e.each(o, function (o, a) {
                                                ...
                                                return s === i
                                                    ...
                                                    : (h.verbose("Found required variable", r, s), (s = v.encodeParameters ? h.get.urlEncodedValue(s) : s), (t = t.replace(a, s)), void 0);
                                            })),
                                        a &&
                                            ...
                                            e.each(a, function (o, a) {
                                                var r = -1 !== a.indexOf("$") ? a.substr(3, a.length - 4) : a.substr(2, a.length - 3),
                                                    s = e.isPlainObject(n) && n[r] !== i ? n[r] : S.data(r) !== i ? S.data(r) : D.data(r) !== i ? D.data(r) : n[r];
                                                s !== i
                                                    ? (h.verbose("Optional variable Found", r, s), (t = t.replace(a, s)))
                                                    : (h.verbose("Optional variable not found", r), (t = -1 !== t.indexOf("/" + a) ? t.replace("/" + a, "") : t.replace(a, "")));
                                            }))),
                                    t
                                );
                            },
                            formData: function (t) {
                                ...
                                return (
                                    ...
                                    n
                                        ? o
                                            ? (h.debug("Extending existing data with form data", t, a), (t = e.extend(!0, {}, t, a)))
                                            : (h.error(C.missingSerialize), h.debug("Cant extend data. Replacing data with form data", t, a), (t = a))
                        ...
                        event: {
                            ...
                            xhr: {
                                always: function () {},
                                    ...
                                    (r = r > 0 ? r : 0),
                                        s && (h.debug("Modified API response in onResponse callback", v.onResponse, s, t), (t = s)),
                            ...
                            request: {
                                ...
                                fail: function (e, t, n) {
                                    ...
                                    "aborted" == t
                                        ? (h.debug("XHR Aborted (Most likely caused by page navigation or CORS Policy)", t, n), v.onAbort.call(E, t, S, e))
                                        : "invalid" == t
                                        ? h.debug("JSON did not pass success test. A server-side error has most likely occurred", o)
                                        : "error" == t && e !== i && (h.debug("XHR produced a server error", t, n), 200 != e.status && n !== i && "" !== n && h.error(C.statusMessage + n, a.url), v.onError.call(E, r, S, e)),
                                        v.errorDuration && "aborted" !== t && (h.debug("Adding error state"), h.set.error(), h.should.removeError() && setTimeout(h.remove.error, v.errorDuration)),
                        ...
                        create: {
                            ...
                            mockedXHR: function () {
                                var t,
                                    ...
                                    r = !1;
                                return (
                                    (i = e.Deferred().always(h.event.xhr.complete).done(h.event.xhr.done).fail(h.event.xhr.fail)),
                                    v.mockResponse
                                        ? (e.isFunction(v.mockResponse)
                                              ? (h.debug("Using mocked callback returning response", v.mockResponse), (n = v.mockResponse.call(E, v)))
                                              : (h.debug("Using specified response", v.mockResponse), (n = v.mockResponse)),
                                        ...
                                        : e.isFunction(v.mockResponseAsync) &&
                                          ...
                                          h.debug("Using async mocked response", v.mockResponseAsync),
                        ...
                        get: {
                            ...
                            settings: function () {
                                ...
                                return (
                                    ...
                                    e &&
                                        (e.success !== i && (h.debug("Legacy success callback detected", e), h.error(C.legacyParameters, e.success), (e.onSuccess = e.success)),
                                        e.failure !== i && (h.debug("Legacy failure callback detected", e), h.error(C.legacyParameters, e.failure), (e.onFailure = e.failure)),
                                        e.complete !== i && (h.debug("Legacy complete callback detected", e), h.error(C.legacyParameters, e.complete), (e.onComplete = e.complete))),
                            ...
                            event: function () {
                                return e.isWindow(R) || "now" == v.on
                                    ? (h.debug("API called without element, no events attached"), !1)
                                    : "auto" == v.on
                                    ? S.is("input")
                                        ? R.oninput !== i
                                            ? "input"
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                v.performance && ((t = new Date().getTime()), (i = s || t), (n = t - i), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", "Execution Time": n })),
    ...
    (function (e, t, n, i) {
        ...
        (e.fn.state = function (t) {
                    ...
                    (n = {
                            ...
                            state: function () {
                                ...
                                if (n.allows("active") && n.is.enabled()) {
                                    if ((n.refresh(), e.fn.api !== i))
                                        if (((t = C.api("get request")), (o = C.api("was cancelled"))))
                        ...
                        change: {
                            ...
                            text: function () {
                                n.is.textEnabled() &&
                                    (n.is.disabled()
                                        ? (n.verbose("Changing text to disabled text", b.hover), n.update.text(b.disabled))
                                        : n.is.active()
                                        ? b.hover
                                            ? (n.verbose("Changing text to hover text", b.hover), n.update.text(b.hover))
                                            : b.deactivate && (n.verbose("Changing text to deactivating text", b.deactivate), n.update.text(b.deactivate))
                                        : b.hover
                                        ? (n.verbose("Changing text to hover text", b.hover), n.update.text(b.hover))
                                        : b.activate && (n.verbose("Changing text to activating text", b.activate), n.update.text(b.activate)));
                            },
                        },
                        activate: function () {
                        ...
                        performance: {
                            log: function (e) {
                                var t, i, o;
                                f.performance && ((t = new Date().getTime()), (o = s || t), (i = t - o), (s = t), c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: w, "Execution Time": i })),
            ...
            (e.fn.state.settings = {
                ...
                selector: { text: !1 },
                defaults: { input: { disabled: !0, loading: !0, active: !0 }, button: { disabled: !0, loading: !0, active: !0 }, progress: { active: !0, success: !0, warning: !0, error: !0 } },
                    ...
                    (g = {
                        initialize: function () {
                            g.debug("Initializing", p),
                                g.setup.cache(),
                                g.should.trackChanges() && ("image" == p.type && g.setup.image(), "fixed" == p.type && g.setup.fixed(), p.observeChanges && g.observeChanges(), g.bind.events()),
                                g.save.position(),
                        ...
                        observeChanges: function () {
                            "MutationObserver" in t &&
                                ((m = new MutationObserver(function (e) {
                                    g.verbose("DOM tree modified, updating visibility calculations"),
                                        (g.timer = setTimeout(function () {
                        ...
                        set: {
                            fixed: function () {
                                g.verbose("Setting element to fixed position"), k.addClass(h.fixed).css({ position: "fixed", top: p.offset + "px", left: "auto", zIndex: "1" });
                            },
                            image: function (t) {
                        ...
                        checkVisibility: function (e) {
                            g.verbose("Checking visibility of element", g.cache.element),
                                !R &&
                                    ...
                                    g.topPassed(),
                                    g.bottomPassed(),
                                    p.onUpdate && p.onUpdate.call(D, g.get.elementCalculations()));
                        },
                        passed: function (t, n) {
                        ...
                        topVisibleReverse: function (e) {
                            var t = g.get.elementCalculations(),
                                ...
                                o = "topVisibleReverse";
                            return (
                                e && (g.debug("Adding callback for top visible reverse", e), (p.onTopVisibleReverse = e)),
                                t.topVisible ? p.once || g.remove.occurred(o) : g.get.occurred("topVisible") && g.execute(n, o),
                        ...
                        bottomVisibleReverse: function (e) {
                            ...
                            return (
                                e && (g.debug("Adding callback for bottom visible reverse", e), (p.onBottomVisibleReverse = e)),
                                t.bottomVisible ? p.once || g.remove.occurred(o) : g.get.occurred("bottomVisible") && g.execute(n, o),
                        ...
                        topPassedReverse: function (e) {
                            var t = g.get.elementCalculations(),
                                ...
                                o = "topPassedReverse";
                            return (
                                e && (g.debug("Adding callback for top passed reverse", e), (p.onTopPassedReverse = e)),
                                t.topPassed ? p.once || g.remove.occurred(o) : g.get.occurred("topPassed") && g.execute(n, o),
                        ...
                        bottomPassedReverse: function (e) {
                            ...
                            return (
                                e && (g.debug("Adding callback for bottom passed reverse", e), (p.onBottomPassedReverse = e)),
                                t.bottomPassed ? p.once || g.remove.occurred(o) : g.get.occurred("bottomPassed") && g.execute(n, o),
                        ...
                        remove: {
                            fixed: function () {
                                g.debug("Removing fixed position"), k.removeClass(h.fixed).css({ position: "", top: "", left: "", zIndex: "" });
                            },
                            occurred: function (e) {
                                if (e) {
                        ...
                        performance: {
                            log: function (e) {
                                var t, n, i;
                                p.performance && ((t = new Date().getTime()), (i = c || t), (n = t - i), (c = t), l.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: D, "Execution Time": n })),
                                    clearTimeout(g.performance.timer),
                                    (g.performance.timer = setTimeout(g.performance.display, 500));
                            },
                            display: function () {
